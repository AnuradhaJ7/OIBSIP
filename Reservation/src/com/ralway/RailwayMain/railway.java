...
package com.ralway.RailwayMain;

import java.util.Scanner;

import com.railway.Admin.AdminPage;
import com.railway.user.UserPage;
...
public class railway {
	...
	public void main_menu() throws Exception
	{
		...
		switch(ch)
		{
			...
			case 2: u_user_login();
				break;
			default:System.out.println("Made by Anuradha Jadhav");
				   System.exit(0);
				break;
	...
	public void user_mode() throws Exception
	{
		...
		if(ad.user_login()==1)
		{
			...
			switch(ch)
			{
				...
				case 4: main_menu();
					break;
				default:System.out.println("Anuradha Jadhav");
					 System.exit(0);
					break;
